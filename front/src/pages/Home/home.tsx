...
const Home = () => {
  return (
    ...
    <section className="relative overflow-hidden">
      ...
      <div className="container relative z-10 px-4 lg:py-40 
        ...
        <div className="grid items-center gap-12 md:grid-cols-2">
          <div className="space-y-6">
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <Button variant="outline" className="border-[#b89048] text-[#b89048]">
      ...
      <div className="container px-4 mx-auto">
        <div className="max-w-3xl mx-auto mb-16 text-center">
          ...
          <p className="text-lg text-gray-600">
            D-Talk's internship program offers a unique opportunity to work alongside experienced artists and
            designers, gaining hands-on experience in the creative industry while developing your artistic skills.
          </p>
        </div>
        ...
        <div className="grid gap-8 md:grid-cols-3">
          <div className="p-6 transition-all duration-300 bg-[#f9f5f0] rounded-xl hover:shadow-md">
            ...
            <p className="text-gray-600">
              Develop your skills under the guidance of professional artists and designers who will mentor you
          ...
          <div className="p-6 transition-all duration-300 bg-[#f9f5f0] rounded-xl hover:shadow-md">
            ...
            <p className="text-gray-600">
              Network with industry professionals and fellow interns, creating valuable connections that will benefit
              your future career.
            </p>
          </div>
          ...
          <div className="p-6 transition-all duration-300 bg-[#f9f5f0] rounded-xl hover:shadow-md">
            ...
            <p className="text-gray-600">
              Work on real client projects and build a professional portfolio that showcases your talents and
              abilities.
            </p>
          </div>
        </div>
    ...
    <section className="py-20 bg-[#f9f5f0]">
      <div className="container px-4 mx-auto">
        <div className="max-w-3xl mx-auto mb-16 text-center">
          <h2 className="mb-4 text-3xl font-bold md:text-4xl">Available Internships</h2>
          <p className="text-lg text-gray-600">
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          <InternshipCard
            ...
            duration="3 months"
            type="Remote"
            description="Assist our design team in creating visual assets for various projects, including digital and print materials."
          ...
          <InternshipCard
            ...
            duration="6 months"
            type="Hybrid"
            description="Create digital artwork for our products and collaborate with our team of artists on various creative projects."
            deadline="May 1, 2025"
          />
          ...
          <InternshipCard
            ...
            duration="4 months"
            type="On-site"
            description="Work on user interface and experience design for our digital platforms, focusing on creating intuitive and visually appealing designs."
          ...
          <InternshipCard
            ...
            duration="3 months"
            type="Remote"
            description="Create engaging visual content for our social media channels and help grow our online presence."
          ...
          <InternshipCard
            ...
            duration="6 months"
            type="On-site"
            description="Assist in designing new products that incorporate artistic elements and meet market demands."
          ...
          <InternshipCard
            ...
            duration="4 months"
            type="Hybrid"
            description="Support our art directors in conceptualizing and executing creative campaigns for our clients."
    ...
    <section className="py-20 bg-white">
      <div className="container px-4 mx-auto">
        <div className="max-w-3xl mx-auto mb-16 text-center">
          ...
          <p className="text-lg text-gray-600">Find answers to common questions about our internship program.</p>
        </div>
        ...
        <div className="grid gap-6 md:grid-cols-2">
          <div className="p-6 bg-[#f9f5f0] rounded-xl">
            ...
            <p className="text-gray-600">
              Yes, all our internships offer competitive stipends based on the role, duration, and your experience
              level.
            </p>
          </div>

          <div className="p-6 bg-[#f9f5f0] rounded-xl">
            <h3 className="mb-2 text-lg font-bold">What are the eligibility requirements?</h3>
            <p className="text-gray-600">
              Our internships are open to students and recent graduates with relevant skills and a passion for art and
              design.
            </p>
          </div>

          <div className="p-6 bg-[#f9f5f0] rounded-xl">
            <h3 className="mb-2 text-lg font-bold">Can international students apply?</h3>
            <p className="text-gray-600">
              Yes, we welcome applications from international students who meet the visa requirements for working in
              our location.
            </p>
          </div>
          ...
          <div className="p-6 bg-[#f9f5f0] rounded-xl">
            ...
            <p className="text-gray-600">
              Outstanding interns are often considered for full-time positions based on their performance and our
              hiring needs.
            </p>
          </div>

          <div className="p-6 bg-[#f9f5f0] rounded-xl">
            <h3 className="mb-2 text-lg font-bold">What software skills are required?</h3>
            <p className="text-gray-600">
              Required skills vary by position, but proficiency in industry-standard design software is generally
              expected.
            </p>
          </div>

          <div className="p-6 bg-[#f9f5f0] rounded-xl">
            <h3 className="mb-2 text-lg font-bold">How many hours per week will I work?</h3>
            <p className="text-gray-600">
              Most internships require 20-40 hours per week, depending on the position and whether it's part-time or
              full-time.
            </p>
          </div>
        </div>
